...
const BreedModal = (props) => {
	...
	return (
		...
		>
			<Modal.Header>繁殖毛孩</Modal.Header>
			<Modal.Content>
				<Form>
					<Form.Input fluid label="毛孩一" readOnly value={kitty.id} />
					<Form.Input fluid label="毛孩二" placeholder="毛孩ID" onChange={formChange("target")} />
				</Form>
			</Modal.Content>
			<Modal.Actions>
				<Button basic color="grey" onClick={() => setOpen(false)}>
